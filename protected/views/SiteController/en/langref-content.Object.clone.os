...
END,
	extDesc = <<<END"
<p>
Метод <code>clone</code> делает не глубокое клонирование, т.е. копируется только 
сам объект-контейнер без рекурсивного копирования значений внутри контейнера.
